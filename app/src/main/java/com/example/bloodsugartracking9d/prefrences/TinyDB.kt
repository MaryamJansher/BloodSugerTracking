package com.example.bloodsugartracking9d.prefrences
...
public class TinyDB(appContext: Context) {
  ...
  fun getinstance() : TinyDB? {
    ...
    fun getBoolean_toggle(key: String): Boolean {
    ...
    fun putBooleanint(key: String, value: Boolean) {
        checkForNullKey(key)
        preferences.edit().putBoolean(key, value).apply()
    }
    /**
